...
<body>
	...
	<div class="menu-wrap">
		<nav class="menu">
			<ul class="clearfix">
				...
				<li class="current-item"><a>Online Services <span
						class="arrow">&#9660;</span></a>

					<ul class="sub-menu">
						<li class="current-item"><a href="/internet/request/new">Submit
								Certificate Request</a></li>
	...
	<br>
	<center>
		<h2 style="position: fixed; left: 45%">Submit New Request</h2>
	</center>
	<br>
	<div class="all-centered">
		<form:form method="POST" action="/internet/addNewRequest">
			<table>
				<tr>
				...
				<tr>
					<td><form:label path="repName">Name:</form:label></td>
