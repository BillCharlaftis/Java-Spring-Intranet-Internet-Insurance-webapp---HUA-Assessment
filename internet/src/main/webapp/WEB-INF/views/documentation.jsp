			...
			<ul class="clearfix">
				...
				<li class="current-item"><a href="#">Informational Material
					...
					<ul class="sub-menu">
						...
						<li class="current-item"><a href="/internet/documentation">Documentation</a></li>
...
<script language="javascript">
	var departments = "${documentation}";

	for (var i = 0; i <= 100; i++) {
		departments = departments.replace("},{", "<br>").replace("{", "")
				.replace("}", "").replace(", 0","").replace(", ","").replace("rule=", "").replace("[", "")
				.replace("]", "").replace("Documentation=", "");
	}

	document.getElementById("doc").innerHTML = departments;
