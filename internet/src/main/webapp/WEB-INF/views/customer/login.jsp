...
<body>
		...
		<nav class="menu">
			<ul class="clearfix">
				...
				<li><a href="#">Online Services <span class="arrow">&#9660;</span></a>
					...
					<li class="current-item"><a href="/internet/user">Log in</a>
	...
	<div class="all-centered">
		...
		<form:form method="POST" action="/internet/checkCustomer">
			<table>
				<tr>
					<td><form:label path="AAM">Username:</form:label></td>
					<td><form:input path="AAM" value="AAM" /></td>
				</tr>
				<tr>
					<td><form:label path="Username">Password:</form:label></td>
					<td><form:input type="password" path="Username" value="password" /></td>
				</tr>
				<tr>
